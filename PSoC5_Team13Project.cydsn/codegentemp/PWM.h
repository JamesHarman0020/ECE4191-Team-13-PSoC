...
#define PWM_CompareMode1SW                 (1u)
#define PWM_CompareMode2SW                 (1u)
...
**************************************/
#define PWM_INIT_PERIOD_VALUE          (6400u)
...
#define PWM_DEFAULT_COMPARE2_MODE      (uint8)((uint8)5u <<  PWM_CTRL_CMPMODE2_SHIFT)
#define PWM_DEFAULT_COMPARE1_MODE      (uint8)((uint8)5u <<  PWM_CTRL_CMPMODE1_SHIFT)
