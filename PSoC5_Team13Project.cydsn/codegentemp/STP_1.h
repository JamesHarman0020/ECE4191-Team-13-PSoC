...
#if !(CY_PSOC5A &&\
	 STP_1__PORT == 15 && ((STP_1__MASK & 0xC0) != 0))
...
void    STP_1_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the STP_1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(STP_1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in STP_1_SetInterruptMode() function.
     *  @{
     */
        #define STP_1_INTR_NONE      (uint16)(0x0000u)
        #define STP_1_INTR_RISING    (uint16)(0x0001u)
        #define STP_1_INTR_FALLING   (uint16)(0x0002u)
        #define STP_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define STP_1_INTR_MASK      (0x01u) 
#endif /* (STP_1__INTSTAT) */
...
/* SIO registers */
#if defined(STP_1__SIO_CFG)
    #define STP_1_SIO_HYST_EN        (* (reg8 *) STP_1__SIO_HYST_EN)
    #define STP_1_SIO_REG_HIFREQ     (* (reg8 *) STP_1__SIO_REG_HIFREQ)
    #define STP_1_SIO_CFG            (* (reg8 *) STP_1__SIO_CFG)
    #define STP_1_SIO_DIFF           (* (reg8 *) STP_1__SIO_DIFF)
#endif /* (STP_1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define STP_1_0_INTTYPE_REG 		(* (reg8 *) STP_1__0__INTTYPE)
#endif /* (STP_1__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_STP_1_H */
