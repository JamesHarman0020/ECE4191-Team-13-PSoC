...
#if !(CY_PSOC5A &&\
	 STP_2__PORT == 15 && ((STP_2__MASK & 0xC0) != 0))
...
void    STP_2_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the STP_2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(STP_2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in STP_2_SetInterruptMode() function.
     *  @{
     */
        #define STP_2_INTR_NONE      (uint16)(0x0000u)
        #define STP_2_INTR_RISING    (uint16)(0x0001u)
        #define STP_2_INTR_FALLING   (uint16)(0x0002u)
        #define STP_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define STP_2_INTR_MASK      (0x01u) 
#endif /* (STP_2__INTSTAT) */
...
/* SIO registers */
#if defined(STP_2__SIO_CFG)
    #define STP_2_SIO_HYST_EN        (* (reg8 *) STP_2__SIO_HYST_EN)
    #define STP_2_SIO_REG_HIFREQ     (* (reg8 *) STP_2__SIO_REG_HIFREQ)
    #define STP_2_SIO_CFG            (* (reg8 *) STP_2__SIO_CFG)
    #define STP_2_SIO_DIFF           (* (reg8 *) STP_2__SIO_DIFF)
#endif /* (STP_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define STP_2_0_INTTYPE_REG 		(* (reg8 *) STP_2__0__INTTYPE)
#endif /* (STP_2__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_STP_2_H */
