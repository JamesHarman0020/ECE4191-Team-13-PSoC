...
*
* \funcusage
*  \snippet QuadB_SUT.c usage_QuadB_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet QuadB_SUT.c usage_QuadB_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet QuadB_SUT.c usage_QuadB_Read  
*******************************************************************************/
...
* preferred QuadB_Read() API because the 
* QuadB_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet QuadB_SUT.c usage_QuadB_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: QuadB_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use QuadB_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - QuadB_0_INTR       (First pin in the list)
    *  - QuadB_1_INTR       (Second pin in the list)
    *  - ...
    *  - QuadB_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet QuadB_SUT.c usage_QuadB_SetInterruptMode
    *******************************************************************************/
    void QuadB_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & QuadB_0_INTR) != 0u) 
		{ 
			 QuadB_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet QuadB_SUT.c usage_QuadB_ClearInterrupt
    *******************************************************************************/
