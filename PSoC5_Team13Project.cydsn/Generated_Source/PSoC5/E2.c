...
void E2_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)E2__INTC_NUMBER] = address;
}
...
cyisraddress E2_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)E2__INTC_NUMBER];
}
