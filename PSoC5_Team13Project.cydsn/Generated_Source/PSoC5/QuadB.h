...
*/
     ...
     *  @{
     */
        #define QuadB_INTR_NONE      (uint16)(0x0000u)
        #define QuadB_INTR_RISING    (uint16)(0x0001u)
        #define QuadB_INTR_FALLING   (uint16)(0x0002u)
        #define QuadB_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define QuadB_INTR_MASK      (0x01u) 
#endif /* (QuadB__INTSTAT) */
...
/* SIO registers */
#if defined(QuadB__SIO_CFG)
    #define QuadB_SIO_HYST_EN        (* (reg8 *) QuadB__SIO_HYST_EN)
    #define QuadB_SIO_REG_HIFREQ     (* (reg8 *) QuadB__SIO_REG_HIFREQ)
    #define QuadB_SIO_CFG            (* (reg8 *) QuadB__SIO_CFG)
    #define QuadB_SIO_DIFF           (* (reg8 *) QuadB__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define QuadB_0_INTTYPE_REG 		(* (reg8 *) QuadB__0__INTTYPE)
#endif /* (QuadB__INTSTAT) */
