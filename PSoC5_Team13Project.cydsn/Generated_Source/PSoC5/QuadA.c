...
*
* \funcusage
*  \snippet QuadA_SUT.c usage_QuadA_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet QuadA_SUT.c usage_QuadA_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet QuadA_SUT.c usage_QuadA_Read  
*******************************************************************************/
...
* preferred QuadA_Read() API because the 
* QuadA_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet QuadA_SUT.c usage_QuadA_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: QuadA_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use QuadA_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - QuadA_0_INTR       (First pin in the list)
    *  - QuadA_1_INTR       (Second pin in the list)
    *  - ...
    *  - QuadA_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet QuadA_SUT.c usage_QuadA_SetInterruptMode
    *******************************************************************************/
    void QuadA_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & QuadA_0_INTR) != 0u) 
		{ 
			 QuadA_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet QuadA_SUT.c usage_QuadA_ClearInterrupt
    *******************************************************************************/
