// ======================================================================
// DesignAttempt01.v generated from TopDesign.cysch
// 08/23/2022 at 11:19
...
module SCB_P4_v4_0_4 (
	...
	cy_clock_v1_0
		#(.id("5d1a2857-57d2-4c32-b845-dc2593b2e77f/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5d1a2857-57d2-4c32-b845-dc2593b2e77f/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5d1a2857-57d2-4c32-b845-dc2593b2e77f/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_0_net;
	wire [0:0] tmpFB_0__Pin_0_net;
	wire [0:0] tmpIO_0__Pin_0_net;
	wire [0:0] tmpINTERRUPT_0__Pin_0_net;
	electrical [0:0] tmpSIOVREF__Pin_0_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_0
		 (.oe(tmpOE__Pin_0_net),
		  .y({Net_23}),
		  .fb({tmpFB_0__Pin_0_net[0:0]}),
		  .io({tmpIO_0__Pin_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_0_net),
		  .interrupt({tmpINTERRUPT_0__Pin_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 US (
        ...
        .control_7(Net_358),
        .reset(1'b0));
    defparam US.Bit0Mode = 0;
    defparam US.Bit1Mode = 0;
    defparam US.Bit2Mode = 0;
    defparam US.Bit3Mode = 0;
    defparam US.Bit4Mode = 0;
    defparam US.Bit5Mode = 0;
    defparam US.Bit6Mode = 0;
    defparam US.Bit7Mode = 0;
    defparam US.BitValue = 0;
    defparam US.BusDisplay = 0;
    defparam US.ExtrReset = 0;
    defparam US.NumOutputs = 2;
